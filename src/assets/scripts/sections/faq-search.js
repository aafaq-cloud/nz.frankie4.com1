...
export class FAQSearchSection extends AbstractComponent {
  ...
  initSearchPages() {
    ...
    const defaultParams = 'type=page&view=json&q=handle:faq+body:<query>+OR+title:<query>';
